    ...
    <div class="row">
        <div class="col-md-4 col-sm-12">
            <div class="footer-left">
                <div class="wrap">
                    <a href="index-2.html" class="foot-logo"><img src="team/images/soccer/footer-logo.png"
                            alt="footer-logo"></a>
                    <p>Activated charcoal trust fund ugh prism af, beard marfa air plant stumptown
                        gastropub farm-to-table jianbing.</p>
        ...
        <div class="col-md-4 col-sm-12 col-lg-offset-1">
            <div class="foot-news">
                <h4>Recent news</h4>
                <div class="item">
                    <a href="news.html" class="image"><img class="img-responsive" src="team/images/soccer/foot-news-img.jpg"
                            alt="news-image"></a>
        ...
        <div class=" col-lg-3 col-md-4 col-sm-12">
            <div class="foot-contact">
                ...
                <ul class="contact-list">
                    <li><i class="fa fa-flag" aria-hidden="true"></i><span>276 Upper Parliament Street,
                            Liverpool L8, Great Britain</span></li>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-6">
            <div class="created">
                <a href="#">Created by <img src="team/images/common/created-icon.png" alt="create-by-image">
                    torbara</a>
            </div>
        </div>
    </div>
